...
import {Entry, find, insert, insert_entry,between, is_null_entry, is_null_node, size, fill_rate,is_full, compare} from "./index";
...
describe('BTree', () => {
	...
	it( "etc", () => {
			...
			expect(is_null_entry(entry)).toBeTruthy();
			...
			expect(is_null_node(empty_node, 0)).toBeTruthy();
