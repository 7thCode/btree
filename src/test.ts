...
import {adler32,Record,Node, append_record, binary_search, closest_min, entry, entry_count, erase, erase_entry, exactly_offset, fill_count, find, find_at_node, grater, insert, insert_to_node, key, lesser, max_entry, min_entry, node_record, read, set_grater, set_key, set_lesser, set_value, split_node, update, update_record, value} from "./index";
...
describe('example', () => {
	...
	it('binary_search', () => {
		...
		const s = [1,2,3,6,7,8,9,11,14,15,17,19];
